...
public class ExpressionDictionary : FileBase64_GTA5_pc
{
	...
	public override void Read(ResourceDataReader reader, params object[] parameters)
	{
		...
		ExpressionNameHashes = reader.ReadBlock<ResourceSimpleList64<uint_r>>(Array.Empty<object>());
		Expressions = reader.ReadBlock<ResourcePointerList64<Expression>>(Array.Empty<object>());
	}
	...
	public override Tuple<long, IResourceBlock>[] GetParts()
	{
		...
		{
			new Tuple<long, IResourceBlock>(32L, ExpressionNameHashes),
			new Tuple<long, IResourceBlock>(48L, Expressions)
		};
	}
}
