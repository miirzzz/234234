...
public class ResourcePointerList<T> : ResourceSystemBlock, IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable where T : IResourceSystemBlock, new()
{
	...
	public override void Read(ResourceDataReader reader, params object[] parameters)
	{
		...
		data_items = reader.ReadBlockAt<ResourcePointerArray<T>>(DataPointer, new object[1] { DataCount1 });
	}

	public override void Write(ResourceDataWriter writer, params object[] parameters)
	{
		DataPointer = (uint)data_items.Position;
