...
public class BoundDictionary : FileBase64_GTA5_pc
{
	...
	public override void Read(ResourceDataReader reader, params object[] parameters)
	{
		...
		BoundNameHashes = reader.ReadBlock<ResourceSimpleList64<uint_r>>(Array.Empty<object>());
		Bounds = reader.ReadBlock<ResourcePointerList64<Bound>>(Array.Empty<object>());
	}
	...
	public override Tuple<long, IResourceBlock>[] GetParts()
	{
		...
		{
			new Tuple<long, IResourceBlock>(32L, BoundNameHashes),
			new Tuple<long, IResourceBlock>(48L, Bounds)
		};
	}
}
